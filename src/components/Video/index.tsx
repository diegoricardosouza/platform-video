                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-6">
                            <img 
                                ...
                                src="https://avatars.githubusercontent.com/u/24964091?v=4" 
                                alt="" 
                            />

                            <div className="leading-relaxed">
                                <strong className="font-bold text-2xl block">Diego Ricardo</strong>
                                <span className="text-gray-200 text-sm block">Developer Fullstack</span>
                            </div>
                        </div>
                    </div>
